  ...
  return (
    ...
    >
      <table
        data-slot="table"
        className={cn(
          'w-full min-w-max caption-bottom table-auto text-sm',
          className,
        )}
        {...props}
      />
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-11 px-4 py-3 text-left align-middle text-xs font-semibold uppercase tracking-wide text-muted-foreground',
